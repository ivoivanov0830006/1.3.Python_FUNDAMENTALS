def insert_space_func(current_data):
...
def change_all_func(current_data):
    global final_message
    substring = current_data[1]
...
while True:
    ...
    if action == "InsertSpace":
        print(insert_space_func(current_command))
    elif action == "Reverse":
        print(reverse_func(current_command))
    elif action == "ChangeAll":
        print(change_all_func(current_command))
